...
with DAG(
    dag_id="yellow_taxi_monthly_training",
    default_args=default_args,
    description="Monthly pipeline: read, prep, train Linear Regression, register with MLflow",
    ...
    tags=["nyc", "taxi", "ml", "linear_regression", "mlflow"],
) as dag:
    ...
    def _train_for_execution_date(execution_date, **context):
        ...
        from src.yellow_taxi_utils import run_training
